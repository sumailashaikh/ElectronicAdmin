...
export class Productlist {
  ...
  private items = signal<Item[]>([
    ...
    },
    {
      ...
      price: 120000,
      inStock: false,
      description: 'Powerful laptop for serious gamers.',
    },
    {
      id: 3,
      ...
      price: 8999,
      inStock: true,
      description: 'Noise-cancelling earbuds with great battery life.',
    },
    {
      id: 4,
      name: 'Smartwatch',
      ...
      price: 15000,
      inStock: true,
      description: 'Fitness tracker and notification hub.',
    },
    {
      id: 5,
      name: 'Ultrabook Z',
  ...
  filterInStock = signal<boolean | null>(null); // Computed signal for filtered items (reactive filtering)
  ...
  categories = ['All', 'Mobile', 'Laptop', 'Accessory']; // Detail view state

  selectedItem: WritableSignal<Item | null> = signal(null);
  showDetailsPopup = signal(false);  // Filter handlers
  /**
